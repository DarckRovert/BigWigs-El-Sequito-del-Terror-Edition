...
### 5. La Interfaz: pfUI (Séquito Edition)
Visualización premium y alertas centralizadas sincronizadas con la IA.

### 6. El Soporte Vital: HealBot
Coordinación de sanación táctica y monitoreo de supervivencia del escuadrón.

### 7. Inteligencia de Mercado: aux-addon
Trading y economía compartida para el dominio financiero del clan.

### 8. Navegación Táctica: Atlas-TW + pfQuest
Guía de campaña y mapas de instancia con waypoints de IA.
