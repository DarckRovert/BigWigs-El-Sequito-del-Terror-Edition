...
local function isInKara()
	-- Commented: Tower of Karazhan is a Turtle WoW custom zone not in Babble-Zone-2.2
	return --AceLibrary("Babble-Zone-2.2")["Tower of Karazhan"] == GetRealZoneText() or
			GetRealZoneText() == "Outland" or
			GetRealZoneText() == "The Rock of Desolation" or
			GetRealZoneText() == "Tower of Karazhan" or
			GetRealZoneText() == "Tower of Karazhan"
end
