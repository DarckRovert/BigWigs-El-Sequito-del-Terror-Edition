...
L:RegisterTranslations("esES", function()
	return {
		...
		["msg"] = "msg",
		["anchor"] = "ancla",
		-- ["reset"] = true, -- Commented: only enUS can use true
		["rw"] = "rw",
		["color"] = "color",
		["scale"] = "escala",
		...
		-- ["Reset position"] = true, -- Commented: only enUS can use true
		-- ["Reset the anchor position, moving it to the default location"] = true, -- Commented: only enUS can use true
