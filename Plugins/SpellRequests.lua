...
local Spells = {
	...
	sunwell = {
		spellName = "Innervate", -- Grace of the Sunwell not in Babble-Spell
	...
	spiritlink = {
		spellName = "Innervate", -- Spirit Link not in Babble-Spell
...
for spellKey, spellData in pairs(Spells) do
	...
	local localizedSpellName = BS[spellData.spellName] or spellData.spellName
