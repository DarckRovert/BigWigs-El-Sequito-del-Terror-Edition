...
L:RegisterTranslations("esES", function() return {
	...
	trigger_frostbreathCast = "Gahz\'ranka comienza a lanzar Aliento de Escarcha\.",
	bar_frostbreathCast = "Aliento de Escarcha Daño+QuemaMana",
	msg_frostbreathCast = "Aliento de Escarcha, Daño + Quema de Maná",
	bar_frostbreathCd = "Aliento de Escarcha CD",
	trigger_frostbreathYou = "Aliento de Escarcha te golpea",
	msg_frostBreathYou = "¡Te quemaron el maná con Aliento de Escarcha!",
	trigger_geyserBegin = "Gahz\'ranka comienza a lanzar Géiser monumental\.",
	bar_geyserCast = "Lanzamiento - Pérdida de Aggro",
	msg_geyserCast = "Lanzamiento - Pérdida de Aggro",
	trigger_geyserCast = "Gahz'ranka lanza Géiser monumental\.",
	bar_geyserCd = "Lanzamiento Pérdida Aggro CD",
	
	trigger_slam = "Gahz'ranka Golpe",
	bar_slam = "Empujón - CD",
	...
	geyser_name = "Alerta de Géiser monumental",
	geyser_desc = "Avisa cuando el jefe lance Géiser monumental.",
	
	slam_name = "Alerta de Golpe",
	slam_desc = "Avisa cuando el jefe lance Golpe.",
} end )
