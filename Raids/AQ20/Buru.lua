...
L:RegisterTranslations("esES", function() return {
	...
	--watch_cmd = "watch",
	watch_name = "Alerta de Observar",
	watch_desc = "Avisa cuando alguien está siendo observado",
	
	--dismember_cmd = "dismember",
	dismember_name = "Alerta de Desmembrar",
	dismember_desc = "Avisa cuando se lanza Desmembrar",
	
	--phase_cmd = "phase",
	phase_name = "Alerta de Fase",
	phase_desc = "Avisa de los cambios de fase",
	
	trigger_watch = "sets eyes on (.+)!",
	msg_watch = " está siendo observado!",
	trigger_watchEnd = "Buru Egg's Explosion hits Buru the Gorger for",
	msg_watchEnd = "Buru dejó de seguirte.",
	
	trigger_dismemberYouOne = "You are afflicted by Dismember.",
		trigger_dismemberYouMore = "You are afflicted by Dismember %((.+)%).",
	trigger_dismemberOtherOne = "(.+) is afflicted by Dismember.",
		trigger_dismemberOtherMore = "(.+) is afflicted by Dismember %((.+)%).",
	bar_dismember = " Desmembrar",
	
	msg_phase2 = "Fase 2, ¡DPS a Buru!",
} end )
