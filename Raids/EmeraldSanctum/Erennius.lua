...
L:RegisterTranslations("esES", function() return {
	...
	wailoferennius_cmd = "gemidoerennius",
	wailoferennius_name = "Alerta de Gemido de Erennius",
	wailoferennius_desc = "Avisar sobre Gemido de Erennius",

	howloferennius_cmd = "aullidoerennius",
	howloferennius_name = "Alerta de Aullido de Erennius",
	howloferennius_desc = "Avisa sobre Aullido de Erennius",
	
	volley_cmd = "descarga",
	volley_name = "Alerta de Descarga de Veneno",
	volley_desc = "Avisa sobre Descarga de Veneno (Volley)",
	
	--Erennius vv
	trigger_wailOfErenniusCast = "Erennius begins to cast Wail of Erennius.", -- Se mantiene en inglés
	bar_wailOfErenniusCast = "Casteando Gemido",
	bar_wailOfErenniusAfflicted = "Afectado por Gemido",
	bar_wailOfErenniusCd = "CD Gemido de Erennius",
	
	trigger_howlOfErennius = "afflicted by Howl of Erennius", -- Se mantiene en inglés
	trigger_howlOfErenniusResist = "Howl of Erennius was resisted", -- Se mantiene en inglés
	bar_howlOfErenniusCD = "CD Silencio",
	bar_howlOfErenniusAfflicted = "¡Silenciado!",
	
	trigger_volley = "afflicted by Poison Bolt Volley", -- Se mantiene en inglés
	bar_volley = "Descarga de Veneno",
	--Erennius ^^
