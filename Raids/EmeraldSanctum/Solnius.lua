...
L:RegisterTranslations("esES", function() return {
	...
	transitions_cmd = "faes",
	transitions_name = "Alerta de Transiciones",
	transitions_desc = "Avisar sobre Transiciones",
	
	bar_isImmune = "Solnius es Inmune",
	msg_isImmune = "¡Solnius es Inmune!",
	
	trigger_solniusSleep = "Solnius gains Sleep Visual DND.", -- Se mantiene en inglés (combat log)
	trigger_solniusSleepFade = "Sleep Visual DND fades from Solnius.", -- Se mantiene en inglés (combat log)
	bar_isSleeping = "Solnius está Durmiendo",
	msg_isSleeping = "¡Enemigos en camino! 45 seg para matar",
	msg_isSleepingFade = "¡Solnius está Despierto!",
	
	trigger_engage = "You think you can interfere with my eternal duty?", -- Se mantiene en inglés (yell) por seguridad
	
	trigger_hardMode = "You will not disturb the Awakener...", -- Se mantiene en inglés (yell)
	msg_hardModeOn = "Erennius se une a la pelea; Hard Mode - ¡Buena Suerte!",
	msg_hardModeOff = "Erennius murió antes que Solnius; Hard Mode Cancelado - *gallina*",
} end )
